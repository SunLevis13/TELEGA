...
class Database:
    ...
    def connection(self):
        return sqlite3.connect(self.db_path) # функция отвечает за подключение к базе данных, путь хранится в dp_path
    ...
    def create_table_users(self): #команда создать пустую таблицу sql
        sql = """
        CREATE TABLE Users(
        id int NOT NULL,
        phone text,
